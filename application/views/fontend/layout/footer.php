  ...
  <div class="container">
    <div class="footer-info">
      ...
      <div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".9s">
        <h3>Subscribe</h3>
        <p>Sign Up Now For More Information <br>
          About Our Company </p>
        <form>
...
<!--//footer--> 
<!--search jQuery--> 
<script src="<?php echo base_url('template/fontend/js/main.js');?>"></script>
...
<script src="<?php echo base_url('template/fontend/js/bootstrap.js');?>"></script> 
